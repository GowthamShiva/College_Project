            ...
            <div className="userActions">
                ...
                >
                  <Avatar
                    sx={{
                      width: 32,
                      height: 32,
                      color: active ? '#bf1d1d' : 'black', // Change color based on active state
                      bgcolor: active ? 'black' : '#801a1a', // Change background color based on active state
                    }}
                  >
                    {user.name[0]}
                  </Avatar>
              ...
              <Menu
                ...
                PaperProps={{
                  elevation: 0,
                  sx: {
                    bgcolor: 'black', // Set the dropdown background color to black
                    ...
                    '& .MuiAvatar-root': {
                      ...
                      bgcolor: '#bf1d1d', // Set avatar background color to #bf1d1d
                    },
                    '&::before': {
                      content: '""',
                      display: 'block',
                      ...
                      width: 10,
                      height: 10,
                      bgcolor: 'black', // Ensure the arrow color matches the background
              ...
              >
                ...
                <Link to={"http://localhost:5173/"}><MenuItem sx={{ color: 'white' }} onClick={handleClose}>
                  <Avatar /> <p className="p">Home</p>
                </MenuItem></Link>
                <Divider sx={{ bgcolor: 'gray' }} />
                <Link to={"/myGigs"}><MenuItem sx={{ color: 'white' }} onClick={handleClose}>
                  <ListItemIcon sx={{ color: 'white' }}>
                    <PersonAdd sx={{ bgcolor: '#bf1d1d', borderRadius: '50%', p: 0.5 }} fontSize="small" />
                  </ListItemIcon>
                 <p className="p">My Services</p>
                </MenuItem></Link>
                {/* <MenuItem sx={{ color: 'white' }} onClick={handleClose}>
                  <ListItemIcon sx={{ color: 'white' }}>
                    <Settings sx={{ bgcolor: '#bf1d1d', borderRadius: '50%', p: 0.5 }} fontSize="small" />
                  </ListItemIcon>
                  Settings
                </MenuItem> */}
                <MenuItem sx={{ color: 'white' }} onClick={handleLogout}>
                  <ListItemIcon sx={{ color: 'white' }}>
                    <Logout sx={{ bgcolor: '#bf1d1d', borderRadius: '50%', p: 0.5 }} fontSize="small" />
                  </ListItemIcon>
                  Logout
                </MenuItem>
              </Menu>
